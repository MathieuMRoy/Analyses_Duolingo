...
SCRAPER_START_DELAY_MIN = float(os.getenv("SCRAPER_START_DELAY_MIN", "0.0"))
SCRAPER_START_DELAY_MAX = float(os.getenv("SCRAPER_START_DELAY_MAX", "5.0"))
SCRAPER_COOLDOWN_DELAY_MIN = float(os.getenv("SCRAPER_COOLDOWN_DELAY_MIN", "1.0"))
SCRAPER_COOLDOWN_DELAY_MAX = float(os.getenv("SCRAPER_COOLDOWN_DELAY_MAX", "2.5"))
