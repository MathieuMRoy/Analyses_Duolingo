...
def render_quarterly_nowcast_sheet(
    ...
    def write_card(
        ...
        note_fill: str = styles["LIGHT_GREY"],
    ) -> None:
        write_box(
    ...
    summary_formula = (
        ...
        f'&" | Trimestre affiche : "&$C$4'
        f'&" | Statut : "&{_raw_lookup_expr("snapshot_status_label")}'
        f'&" | Jours observes : "&{_raw_lookup_expr("observed_days")}'
    ...
    write_box(
        "D4:H4",
        "Choisissez un trimestre pour consulter son snapshot fige et ses estimations.",
        fill=analyst_canvas,
    ...
    write_card(
        ...
        "Score synthetique du trimestre",
        section_fill,
        value_fill=analyst_surface,
        note_fill=analyst_slate,
    )
