diff --git a/duolingo_analyzer/agent.py b/duolingo_analyzer/agent.py
index 98da74eb0506e83f307c3eac0268c5bf5c850261..a1bc4f4dcb3bfacbfe41fc558350701ca5c2475a 100644
--- a/duolingo_analyzer/agent.py
+++ b/duolingo_analyzer/agent.py
@@ -1,112 +1,122 @@
 """
...
-    date = stats["date_jour"]
-    moy = stats["moyenne_streak_jour"]
-    actifs = stats["utilisateurs_actifs"]
-    tombes = stats["streaks_tombes_zero"]
-    total = stats["nb_profils_jour"]
...
-    retention = stats.get("taux_retention", 0)
-    churn = stats.get("taux_churn", 0)
-    sante = stats.get("score_sante_jour", 0)
-    conversion = stats.get("taux_conversion_plus", 0)
-    delta_xp = stats.get("delta_xp_moyen", 0)
...
-        evolution = moy - stats["moyenne_streak_hier"]
...
-        f"  - Abandon Débutants : {cohortes.get('Debutants', {}).get('churn', 0):.1f}%\n"
-        f"  - Abandon Standard : {cohortes.get('Standard', {}).get('churn', 0):.1f}%\n"
-        f"  - Abandon Super-Actifs : {cohortes.get('Super-Actifs', {}).get('churn', 0):.1f}%\n"
